 ...
 * INPUT GRAMMAR:
 * ---
 * import { table2Enum, cleanComment, extractAttrType, extractAttrNode, extractAttrVal, extractAttrId, extractMinVal, extractMaxVal, extractOptions } from "./parserHelpers";
 * ---
